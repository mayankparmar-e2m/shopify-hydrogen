...
export default function HeaderMobile({header, isLoggedIn, cart}) {
  ...
  return (
    ...
    {
        showMobileDrawer && <HeaderMobileDrawer drawerAnimation={drawerAnimation} primaryDomainUrl={primaryDomainUrl} onCloseMobileDrawer={toggleDrwaderAnimation} onDrawerAnimationEnd={closeSideMobileDrawer} showMobileDrawer={showMobileDrawer} mobileNavItems={mobileNavItems}/>
    }
    </>
