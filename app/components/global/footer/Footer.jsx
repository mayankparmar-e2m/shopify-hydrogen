...
export function Footer({menu,primaryDomain,socialMedia,footerIcons}) {
  return (
    <footer className="footer">
     ...
     <FooterDeskNavs menu={menu} primaryDomain={primaryDomain} socialMedia={socialMedia}/>
     <FooterMobileNavs menu={menu} primaryDomain={primaryDomain} socialMedia={socialMedia} /> 
     </div>
